...
// Asumiendo que 'fot_franco.jpg' fue corregido a 'foto_franco.jpg'
  ...
  return (
    ...
    <main className="flex flex-1 items-center justify-center bg-gradient-to-b from-[#0f0f1a] to-[#1a1a2e] text-gray-200">
      <div className="w-full max-w-6xl mx-auto py-16 px-6 md:px-10">
        <div className="flex flex-col md:flex-row items-start gap-12"> {/* items-start para alinear el contenido en la parte superior */}
          ...
          <div className="flex flex-col gap-8 md:w-1/2">
            <div>
              ...
              <p className="text-lg leading-relaxed text-gray-400">
                Somos{" "}
                <strong className="text-yellow-400 font-semibold">CODEando</strong>, una comunidad enfocada en potenciar tu crecimiento profesional a través del aprendizaje práctico, proyectos colaborativos y una red de apoyo constante entre desarrolladores.
              </p>
            </div>
            ...
            {/* Sección Desarrolladores - **LAYOUT CORREGIDO AQUÍ** */}
            <section>
              <h2 className="text-2xl font-semibold text-white mb-6">
                Desarrolladores
              </h2>
              
              {/* Uso de Grid: 1 columna en móvil, 2 columnas en escritorio */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6"> 
                ...
                {/* Franco - Se fuerza a que ocupe las dos columnas para centrarlo perfectamente */}
